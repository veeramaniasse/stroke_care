...
import static com.simats.strokecare.API.Ryles_URL;
...
public class ryles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ryles);
        ...
        button1 = findViewById(R.id.previous);
        button1.setOnClickListener(view -> {
            Intent intent1 = new Intent(ryles.this, ryles_patient.class);
            intent1.putExtra("HID", HID);
            startActivity(intent1);
        });

        button2 = findViewById(R.id.foleys);
        button2.setOnClickListener(view -> {
            Intent intent2 = new Intent(ryles.this, foleys.class);
        ...
        button.setOnClickListener(view -> {
            Intent intent3 = new Intent(ryles.this, patient_dashboard.class);
    ...
    private void sendDateToBackend(String selectedDate) {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    // Create form data
                    String formData = "hospital_id=" + HID + "&ryles_date=" + selectedDate;

                    // Set up the connection
                    URL url = new URL(Ryles_URL); // Replace YOUR_PHP_SCRIPT_URL with the actual URL of your PHP script
                    ...
                    if (spinner.getSelectedItemPosition() == 0) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Dialog myDialog = new Dialog(ryles.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent4 = new Intent(this, foleys.class);
