...
public class physio_rec_patient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physio_rec_patient);
...
//            Intent intent1 = new Intent(physio_rec_patient.this, overall_history.class);
...
//        final String year = "2024";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            Intent intent1 = new Intent(this, overall_history.class);
//            intent1.putExtra("hospitalId", getIntent().getStringExtra("hospitalId"));
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(this, overall_history.class);
