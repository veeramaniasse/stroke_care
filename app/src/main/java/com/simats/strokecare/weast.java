...
public class weast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weast);
    ...
    private void sendDataToDatabase() {
        ...
        if (value.length() >= 4) {
            ...
            Toast.makeText(this, "Hospital ID must be at least 4 characters long", Toast.LENGTH_SHORT).show();
            hideProgressBar();
            return;
        }
        ...
        try {
            ...
            String url = "http://10.0.2.2/php/waste.php";
            ...
            StringRequest stringRequest = new StringRequest(
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if ("success".equals(status)) {
                                    runOnUiThread(() -> {
                                        Toast.makeText(weast.this, "Details updated successfully", Toast.LENGTH_SHORT).show();
                                    });
                                } else {
                                    runOnUiThread(() -> {
                                        Toast.makeText(weast.this, "Failed to update details", Toast.LENGTH_SHORT).show();
                                    });
                                }
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            // Handle errors here
                            runOnUiThread(() -> {
                                Toast.makeText(weast.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                            });
                            hideProgressBar();
                        }
                    }
